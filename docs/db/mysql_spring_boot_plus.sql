...
create database if not exists scp_system character set utf8mb4 COLLATE utf8mb4_general_ci;
...
create database if not exists scp_example character set utf8mb4 COLLATE utf8mb4_general_ci;
